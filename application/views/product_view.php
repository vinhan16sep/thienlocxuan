<section class="content drug container">
    ...
    <div class="drug_list_content">
        <div class="content_title">
            <?php echo $this->lang->line('list_product'); ?>
            <br>
            <div class="line"></div>
        </div>
...
<script>
    $('#drug-type').change(function(){
        var url = '<?php echo site_url('product/filter_product') ?>';
        var base_path = '<?php echo base_url('assets/upload/product/') ?>';
        var detail_url = '<?php echo site_url('product/detail/'); ?>';
        $('.drug_list').html('');
        $.ajax({
            method: 'GET',
            url: url,
            ...
            success: function(res){
                ...
                $.each($.parseJSON(res), function(key, item){
                        ...
                        html += '<a href="' + detail_url + item.product_id + '">';
