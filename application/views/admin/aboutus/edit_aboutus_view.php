    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                echo form_input('title_vi', set_value('title_vi', $aboutus['title_vi']), 'class="form-control"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('content_vi', set_value('content_vi', $aboutus['content_vi'], false), 'class="form-control content"')
                ?>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                echo form_input('title_en', set_value('title_en', $aboutus['title_en']), 'class="form-control"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('content_en', set_value('content_vi', $aboutus['content_en'], false), 'class="form-control content"')
                ?>
            </div>
        </div>
