    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                echo form_input('title_vi', set_value('title_vi', $recruitment['title_vi']), 'class="form-control"');
                ?>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                echo form_input('title_en', set_value('title_en', $recruitment['title_en']), 'class="form-control"');
                ?>
            </div>
            <div class="form-group description">
                <?php
