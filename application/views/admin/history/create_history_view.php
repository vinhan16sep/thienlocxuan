    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                echo form_input('year', set_value('year'), 'class="form-control"');
                ?>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                echo form_textarea('content_vi', set_value('content_vi', '', false), 'class="form-control content"')
                ?>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                echo form_textarea('content_en', set_value('content_en', '', false), 'class="form-control content"')
                ?>
            </div>
        </div>
