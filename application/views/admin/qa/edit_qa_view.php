    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                echo form_input('title_vi', set_value('title_vi', $qa['title_vi']), 'class="form-control"');
                ?>
            </div>
            <div class="form-group description">
                ...
                echo form_textarea('description_vi', set_value('description_vi', $qa['description_vi']), 'class="form-control"');
                ?>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                echo form_input('title_en', set_value('title_en', $qa['title_en']), 'class="form-control"');
                ?>
            </div>
            <div class="form-group description">
                <?php
                ...
                echo form_textarea('description_en', set_value('description_en', $qa['description_en']), 'class="form-control"');
                ?>
            </div>
        </div>
