    ...
    <div class="row modified-mode">
        <div class="col-lg-10 col-lg-offset-0">
            ...
            <div class="form-group">
                ...
                echo form_dropdown('article_project', $list_projects, '', 'class="form-control"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_input('article_title', set_value('article_title'), 'class="form-control"');
                ?>
            </div>
            ...
            <div class="form-group description">
                ...
                echo form_textarea('article_description', set_value('article_description'), 'class="form-control"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('article_content', set_value('article_content'), 'class="form-control article-content"')
                ?>
            </div>
            <br>
