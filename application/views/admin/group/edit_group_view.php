                        ...
                        <div class="checkout-step-body">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    echo form_input('title_vi', set_value('title_vi', $group['title_vi']), 'class="form-control"');
                                    ?>
                                </div>
                        ...
                        <div class="checkout-step-body">
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    echo form_input('title_en', set_value('title_en', $group['title_en']), 'class="form-control"');
                                    ?>
                                </div>
