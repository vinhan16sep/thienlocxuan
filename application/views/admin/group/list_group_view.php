...
<div class="container">
    ...
    <div class="row">
        <a type="button" href="<?php echo site_url('admin/group/create'); ?>" class="btn btn-primary">ADD NEW</a>
        <a type="button" onclick="delete_all('<?php echo base_url('admin/group/delete_multiple') ?>');" class="btn btn-danger">DELETE ALL SELECTED ITEMS</a>
    </div>
    <div class="row">
        <div class="col-lg-12" style="margin-top: 10px;">
            ...
            if (!empty($group)) {
                foreach ($group as $item):
                    ...
                    echo '<td>' . anchor('admin/group/edit/' . $item['id'],  $item['group_title'] . '</td>');
                    //echo '<td>' . $item['group_title'] . '</td>';
                    echo '<td>' . anchor('admin/group/edit/' . $item['id'], '<span class="glyphicon glyphicon-pencil"></span>');
                    //echo ' ' . anchor('admin/group/delete/' . $item['id'], '<span class="glyphicon glyphicon-remove"></span>') . '</td>';
                    echo ' ' . anchor('admin/group/edit/' . $item['id'], '<span data-toggle="modal" data-target="#confirm" class="glyphicon glyphicon-erase"></span>' . '</td>');
                    echo '</tr>';
                endforeach;
            }else {
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <br>
                            <?php
                            echo anchor('admin/group/delete/' . $item['id'], '<button class="btn btn-default" type="submit">Đồng ý</button>');
                            echo ' ';
