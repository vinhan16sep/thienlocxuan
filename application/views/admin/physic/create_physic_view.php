    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                echo form_dropdown('physic_type', $types, set_value('physic_type', 0), 'class="form-control"');
                ?>
            </div>
            <div class="form-group" >
                <?php
                ...
                echo form_dropdown('physic_group', $groups, set_value('physic_group', 0), 'class="form-control"');
                ?>
            </div>
            ...
            <div class="form-group" >
                ...
                <div class="checkbox">
                    <label>
                        ...
                        echo form_checkbox('is_special', 1, false, 'id="is_special"') . 'Sản phẩm đưa lên trang chủ';
                        ?>
                    </label>
                </div>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                echo form_textarea('content_vi', set_value('content_vi', '', false), 'class="form-control product-content"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('faq_vi', set_value('faq_vi', '', false), 'class="form-control product-content"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('ingredients_vi', set_value('ingredients_vi', '', false), 'class="form-control product-content"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('attribution_vi', set_value('attribution_vi', '', false), 'class="form-control product-content"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('dosage_vi', set_value('dosage_vi'), 'class="form-control" id="inputDosage" rows="3"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('contraindicating_vi', set_value('contraindicating_vi'), 'class="form-control" id="inputContraindicating" rows="3"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('expired_vi', set_value('expired_vi'), 'class="form-control" id="inputExpiredDay" rows="3"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('certification_vi', set_value('certification_vi'), 'class="form-control" id="inputCertification" rows="3"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('presentation_vi', set_value('presentation_vi'), 'class="form-control" id="inputPresentation" rows="3"');
                ?>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                echo form_textarea('content_en', set_value('content_en', '', false), 'class="form-control product-content"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('faq_en', set_value('faq_en', '', false), 'class="form-control product-content"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('ingredients_en', set_value('ingredients_en', '', false), 'class="form-control product-content"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('attribution_en', set_value('attribution_en', '', false), 'class="form-control product-content"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('dosage_en', set_value('dosage_en'), 'class="form-control" id="inputDosage" rows="3"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('contraindicating_en', set_value('contraindicating_en'), 'class="form-control" id="inputContraindicating" rows="3"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('expired_en', set_value('expired_en'), 'class="form-control" id="inputExpiredDay" rows="3"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('certification_en', set_value('certification_en'), 'class="form-control" id="inputCertification" rows="3"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('presentation_en', set_value('presentation_en'), 'class="form-control" id="inputPresentation" rows="3"');
                ?>
            </div>
        </div>
