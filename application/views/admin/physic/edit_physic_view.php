<style>
    ...
    .checkout-cart-physics{}

    .checkout-cart-physics .checkout-charges{ padding: 10px 20px;
        color: #333;}
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                <?php
                echo form_label('Loại sản phẩm / Type', 'physic_type');
                echo form_error('physic_type');
                echo form_dropdown('physic_type', $types, set_value('physic_type', $physic['type_id']), 'class="form-control"');
                ?>
            </div>
            <div class="form-group" >
                <?php
                echo form_label('Nhóm sản phẩm / Groups', 'physic_group');
                echo form_error('physic_group');
                echo form_dropdown('physic_group', $groups, set_value('physic_group', $physic['group_id']), 'class="form-control"');
                ?>
            </div>
            ...
            <div class="form-group" >
                ...
                <div class="checkbox">
                    <label>
                        ...
                        echo form_checkbox('is_special', 1, $physic['is_special'] == 1 ? true : false, 'id="is_special"') . 'Sản phẩm đưa lên trang chủ';
                        ?>
                    </label>
                </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                echo form_input('title_vi', set_value('title_vi', $physic['title_vi']), 'class="form-control"');
                ?>
            </div>
            <!--<div class="form-group description">
                ...
                echo form_textarea('description_vi', set_value('description_vi', $physic['description_vi']), 'class="form-control"');
                ?>
            </div>-->
            <div class="form-group">
                <?php
                ...
                echo form_textarea('content_vi', set_value('content_vi', $physic['content_vi'], false), 'class="form-control physic-content"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('faq_vi', set_value('faq_vi', $physic['faq_vi'], false), 'class="form-control physic-content"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('ingredients_vi', set_value('ingredients_vi', $physic['ingredients_vi'], false), 'class="form-control physic-content"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('attribution_vi', set_value('attribution_vi', $physic['attribution_vi'], false), 'class="form-control physic-content"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('dosage_vi', set_value('dosage_vi', $physic['dosage_vi']), 'class="form-control" id="inputDosage" rows="3"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('contraindicating_vi', set_value('contraindicating_vi', $physic['contraindicating_vi']), 'class="form-control" id="inputContraindicating" rows="3"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('expired_vi', set_value('expired_vi', $physic['expired_vi']), 'class="form-control" id="inputExpiredDay" rows="3"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('certification_vi', set_value('certification_vi', $physic['certification_vi']), 'class="form-control" id="inputCertification" rows="3"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('presentation_vi', set_value('presentation_vi', $physic['presentation_vi']), 'class="form-control" id="inputPresentation" rows="3"');
                ?>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                echo form_input('title_en', set_value('title_en', $physic['title_en']), 'class="form-control"');
                ?>
            </div>
            <!--<div class="form-group description">
                <?php
                ...
                echo form_textarea('description_en', set_value('description_en', $physic['description_en']), 'class="form-control"');
                ?>
            </div>-->
            <div class="form-group">
                <?php
                ...
                echo form_textarea('content_en', set_value('content_en', $physic['content_en'], false), 'class="form-control physic-content"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('faq_en', set_value('faq_en', $physic['faq_en'], false), 'class="form-control physic-content"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('ingredients_en', set_value('ingredients_en', $physic['ingredients_en'], false), 'class="form-control physic-content"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('attribution_en', set_value('attribution_en', $physic['attribution_en'], false), 'class="form-control physic-content"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('dosage_en', set_value('dosage_en', $physic['dosage_en']), 'class="form-control" id="inputDosage" rows="3"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('contraindicating_en', set_value('contraindicating_en', $physic['contraindicating_en']), 'class="form-control" id="inputContraindicating" rows="3"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('expired_en', set_value('expired_en', $physic['expired_en']), 'class="form-control" id="inputExpiredDay" rows="3"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('certification_en', set_value('certification_en', $physic['certification_en']), 'class="form-control" id="inputCertification" rows="3"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('presentation_en', set_value('presentation_en', $physic['presentation_en']), 'class="form-control" id="inputPresentation" rows="3"');
                ?>
            </div>
        </div>
