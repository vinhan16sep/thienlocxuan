    ...
    <div class="row modified-mode">
        <div class="col-lg-10 col-lg-offset-0">
            ...
            <div class="form-group description">
                ...
                echo form_textarea('news_description', set_value('news_description', $news['news_description']), 'class="form-control"');
                ?>
            </div>
            <div class="form-group">
                <?php
                ...
                echo form_textarea('news_content', set_value('news_content', $news['news_content'], false), 'class="form-control news-content"')
                ?>
            </div>
            <div class="form-group">
                ...
                echo form_dropdown('news_is_hot', array('0' => 'No', '1' => 'Yes'), set_value('news_is_hot', $news['news_is_hot']), 'class="form-control"');
                ?>
            </div>
            <br>
