    ...
    <div class="row modified-mode">
        <div class="col-lg-10 col-lg-offset-0">
            ...
            <div class="form-group">
                ...
                echo form_textarea('project_description', set_value('project_description', '', false), 'class="form-control"');
                ?>
            </div>
            <div class="form-group">
                ...
                echo form_dropdown('project_ismain', array('0' => 'No', '1' => 'Yes'), set_value('project_ismain', 0), 'class="form-control"');
                ?>
            </div>
            <br>
