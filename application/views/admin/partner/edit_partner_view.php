            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group picture">
                        <?php
                        echo form_label('Chọn ảnh (600 x 470px)', 'partner');
                        echo form_error('partner');
                        echo form_upload('partner', set_value('partner'), 'classs="form-control"');
                        ?>
                    </div>
                    <div class="form-group">
                        ...
                        echo form_error('url');
                        echo form_input('url', set_value('url', $partner['url']), 'class="form-control url"');
                        ?>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <?php
                        echo form_label('Tên đối tác', 'name_vi');
                        echo form_error('name_vi');
                        echo form_input('name_vi', set_value('name_vi', $partner['name_vi']), 'class="form-control text"');
                        ?>
                    </div>
                    <div class="form-group description">
                        ...
                        echo form_textarea('description_vi', set_value('description_vi', $partner['description_vi']), 'class="form-control"');
                        ?>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        echo form_input('name_en', set_value('name_en', $partner['name_en']), 'class="form-control text"');
                        ?>
                    </div>
                    <div class="form-group description">
                        <?php
                        ...
                        echo form_textarea('description_en', set_value('description_en', $partner['description_en']), 'class="form-control"');
                        ?>
                    </div>
                </div>
