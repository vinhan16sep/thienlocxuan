    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                echo form_dropdown('role', array('0' => 'Giám đốc', '1' => 'Phó giám đốc', '2' => 'Nhân viên'), set_value('role', 0), 'class="form-control"');
                ?>
            </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group description">
                ...
                echo form_textarea('bio_vi', set_value('bio_vi'), 'class="form-control"');
                ?>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="form-group description">
                ...
                echo form_textarea('bio_en', set_value('bio_en'), 'class="form-control"');
                ?>
            </div>
        </div>
