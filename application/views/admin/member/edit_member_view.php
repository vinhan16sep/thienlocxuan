    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                <?php
                echo form_label('Role / Chức vụ', 'role');
                echo form_error('role');
                echo form_dropdown('role', array('0' => 'Giám đốc', '1' => 'Phó giám đốc', '2' => 'Nhân viên'), set_value('role', $member['role']), 'class="form-control"');
                ?>
            </div>
            <div class="form-group picture">
                <?php
                echo form_label('Ảnh đại diện / Image (230 x 278)', 'image');
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                echo form_input('name_vi', set_value('name_vi', $member['name_vi']), 'class="form-control"');
                ?>
            </div>
            <div class="form-group description">
                ...
                echo form_textarea('bio_vi', set_value('bio_vi', $member['bio_vi']), 'class="form-control"');
                ?>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <div class="form-group">
                ...
                echo form_input('name_en', set_value('name_en', $member['name_en']), 'class="form-control"');
                ?>
            </div>
            <div class="form-group description">
                <?php
                ...
                echo form_textarea('bio_en', set_value('bio_en', $member['bio_en']), 'class="form-control"');
                ?>
            </div>
        </div>
