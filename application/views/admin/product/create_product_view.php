    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                echo form_dropdown('product_type', $types, set_value('product_type', 0), 'class="form-control"');
                ?>
            </div>
            <div class="form-group" >
                <?php
                ...
                echo form_dropdown('product_group', $groups, set_value('product_group', 0), 'class="form-control"');
                ?>
            </div>
